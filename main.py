...
api_url = "https://master-api-v2.vercel.app/"
api_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNzkxOTMzNDE5NSIsInRnX3VzZXJuYW1lIjoi4p61IFtvZmZsaW5lXSIsImlhdCI6MTczNTE0OTA4MH0.IyENQxCoDudIlujzuXUOFwLQz7dB9POIl4B9y4QSmV8"
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/urban_rider2007"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/urban_rider2007"),
        ],
        [
            InlineKeyboardButton(text="🪄 Updates Channel", url="https://t.me/urban_rider2007"),
        ],
    ]
)
...
async def guide_handler(client: Client, message: Message):
    guide_text = (
        ...
        "3. `/helper .txt` file command - Process the .txt file.\n"
    ...
    try:
        ...
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
              ...
              url = f"https://master-api-v2.vercel.app/allenplus-vimeo?url={url}"
...
if __name__ == "__main__":
    # asyncio.run(main()) # khud pata kr lo tb tk comment kr deya
    bot.run()
